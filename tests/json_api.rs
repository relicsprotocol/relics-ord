...
fn get_output() {
  ...
  pretty_assert_eq!(
    ...
    api::Output {
      ...
      inscriptions: vec![
        api::RelicInscription {
          id: InscriptionId { txid, index: 0 },
          is_base_relic: false
        },
        api::RelicInscription {
          id: InscriptionId { txid, index: 1 },
          is_base_relic: false
        },
        api::RelicInscription {
          id: InscriptionId { txid, index: 2 },
          is_base_relic: false
        },
      ],
      indexed: true,
...
fn outputs_address() {
  ...
  let (inscription_id, reveal) = inscribe_with_options(&core, &ord, Some(10000), None, 1);
  ...
  pretty_assert_eq!(
    ...
    vec![api::Output {
      address: Some(address.parse().unwrap()),
      inscriptions: vec![api::RelicInscription {
        id: InscriptionId {
          txid: reveal,
          index: 0
        },
