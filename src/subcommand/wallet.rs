...
pub(crate) enum Subcommand {
  ...
  Cardinals,
  #[command(about = "Claim Relics collected as swap fees")]
  Claim(claim::Claim),
  #[command(about = "Create new wallet")]
  Create(create::Create),
  #[command(about = "Dump wallet descriptors")]
  Dump,
  #[command(about = "Enshrine a relic")]
  Enshrine(enshrine::Enshrine),
  ...
  Mint(mint::Mint),
  #[command(about = "Mint a base relic")]
  MintBaseRelic(mint_base_relic::MintBaseRelic),
  #[command(about = "Mint a relic by spending the base relic")]
  MintRelic(mint_relic::MintRelic),
  ...
  Sats(sats::Sats),
  #[command(about = "List all relics sealed to an inscription")]
  Sealed,
...
impl WalletCommand {
  pub(crate) fn run(self, settings: Settings) -> SubcommandResult {
    ...
    match self.subcommand {
      ...
      Subcommand::Enshrine(enshrine) => enshrine.run(wallet),
      ...
      Subcommand::MintBaseRelic(mint_base_relic) => mint_base_relic.run(wallet),
      Subcommand::MintRelic(mint_relic) => mint_relic.run(wallet),
