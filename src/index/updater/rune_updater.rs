...
pub(super) struct RuneUpdater<'a, 'tx, 'client, 'emitter> {
...
impl RuneUpdater<'_, '_, '_, '_> {
  ...
  fn create_rune_entry(
    ...
    self
      .event_emitter
      .emit(txid, EventInfo::RuneEtched { rune_id: id })?;
