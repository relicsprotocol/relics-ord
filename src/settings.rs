...
impl Settings {
  ...
  pub fn or(self, source: Settings) -> Self {
    Self {
      ...
      index_relics: self.index_relics || source.index_relics,
      ...
      store_relics_only: self.store_relics_only || source.store_relics_only,
    }
  }
  ...
  pub fn from_options(options: Options) -> Self {
    Self {
      ...
      store_relics_only: options.store_relics_only,
    }
  }
  ...
  pub fn from_env(env: BTreeMap<String, String>) -> Result<Self> {
    ...
    Ok(Self {
      ...
      index_relics: get_bool("INDEX_RELICS"),
      ...
      store_relics_only: get_bool("STORE_RELICS_ONLY"),
    })
  }
  ...
  pub fn or_defaults(self) -> Result<Self> {
    ...
    Ok(Self {
      ...
      index_relics: self.index_relics,
      ...
      store_relics_only: self.store_relics_only,
    })
  }
  ...
  pub fn first_relic_height(&self) -> u32 {
    if self.integration_test {
      0
    } else {
      self.chain.unwrap().first_relic_height()
    }
  }
  ...
  pub fn index_relics_raw(&self) -> bool {
    self.index_relics
  }
  ...
  pub fn store_relics_only(&self) -> bool {
    self.store_relics_only
  }
...
mod tests {
  ...
  #[test]
  fn index_relics() {
    assert!(parse(&["--chain=signet", "--index-relics"]).index_relics_raw());
    assert!(parse(&["--index-relics"]).index_relics_raw());
    assert!(!parse(&[]).index_relics_raw());
  }
