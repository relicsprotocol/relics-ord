...
pub(crate) enum Subcommand {
  ...
  Balances,
  #[command(about = "List all relic balances")]
  RelicBalances,
...
impl Subcommand {
  pub(crate) fn run(self, settings: Settings) -> SubcommandResult {
    match self {
      ...
      Self::RelicBalances => relic_balances::run(settings),
      ...
      Self::Relics => relics::run(settings),
